...
* The quaddec status.
*/
#define CY_TCPWM_QUADDEC_STATUS_DOWN_COUNTING       (0x1u)        /**< QuadDec is down counting */
#define CY_TCPWM_QUADDEC_STATUS_UP_COUNTING         (0x2u)        /**< QuadDec is up counting */
/** QuadDec the counter is running */
#define CY_TCPWM_QUADDEC_STATUS_COUNTER_RUNNING     (0x80000000u)
...
***************************************/
/** \cond INTERNAL */
#define CY_TCPWM_QUADDEC_CTRL_QUADDEC_MODE          (0x3u)     /**< Quadrature encoding mode for CTRL register */
/** \endcond */
