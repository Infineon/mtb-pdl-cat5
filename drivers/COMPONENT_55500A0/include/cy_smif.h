...
*   <tr>
*     <td>2.40</td>
*     <td>Added support for new product family</td>
*     <td>Support for CAT1C devices.</td>
*   </tr>
*   <tr>
*     <td>2.30</td>
*     <td>Added new API's:\n
...
*     <td>The CY_SMIF_CMD_FIFO_WR_RX_COUNT_Msk value is changed to 0x0000FFFFu.</td>
...
#undef SMIF_RX_DATA_FIFO_CTL
#undef SMIF_RX_DATA_FIFO_RD4
#undef SMIF_RX_DATA_FIFO_RD1
#undef SMIF_RX_DATA_FIFO_RD2
#undef SMIF_INTR_RX_DATA_FIFO_UNDERFLOW_Msk
...
#define SMIF_TX_DATA_MMIO_FIFO_STATUS        SMIF_TX_DATA_FIFO_STATUS
#endif

#if (CY_IP_MXSMIF_VERSION==3)
#undef SMIF_TX_DATA_FIFO_CTL
#undef SMIF_TX_DATA_FIFO_WR4
#undef SMIF_TX_DATA_FIFO_WR1
#undef SMIF_TX_DATA_FIFO_WR2
...
#define CY_SMIF_CMD_FIFO_TX_MODE            (0u)
#define CY_SMIF_CMD_FIFO_TX_COUNT_MODE      (1u)
#define CY_SMIF_CMD_FIFO_RX_COUNT_MODE      (2u)
#define CY_SMIF_CMD_FIFO_DUMMY_COUNT_MODE   (3u)
...
#define CY_SMIF_CRYPTO_START                (1u)
#define CY_SMIF_CRYPTO_COMPLETED            (0u)
#define CY_SMIF_CRYPTO_ADDR_MASK            (0xFFFFFFF0u)
...
#define CY_SMIF_BUFFER_SIZE_MAX             (65536u)
#define CY_SMIF_BUF_SIZE_VALID(size)        (((CY_SMIF_BUFFER_SIZE_MAX) >= (size)) && ((0u) < (size)))
...
#define CY_SMIF_CMD_MMIO_FIFO_WR_MODE_Pos            (24u)           /* [26:24]         Command data mode */
#define CY_SMIF_CMD_MMIO_FIFO_WR_MODE_Msk            (0x07000000u)   /* DATA[26:24]       Command data mode    */

#define CY_SMIF_CMD_MMIO_FIFO_WR_SS_Pos              (20u)           /* [23:20]         Slave select         */
#define CY_SMIF_CMD_MMIO_FIFO_WR_SS_Msk              (0x00F00000u)   /* DATA[23:20]     Slave select         */

#define CY_SMIF_CMD_MMIO_FIFO_WR_LAST_BYTE_Pos       (19u)           /* [19]            Last byte            */
#define CY_SMIF_CMD_MMIO_FIFO_WR_LAST_BYTE_Msk       (0x00080000u)   /* DATA[19]        Last byte               */

#define CY_SMIF_CMD_MMIO_FIFO_WR_DATA_RATE_Pos       (18u)           /* [18]         Data Rate         */
#define CY_SMIF_CMD_MMIO_FIFO_WR_DATA_RATE_Msk       (0x00040000u)   /* DATA[18]     Data Reate         */

#define CY_SMIF_CMD_MMIO_FIFO_WR_WIDTH_Pos           (16u)           /* [17:16]         Transfer width       */
#define CY_SMIF_CMD_MMIO_FIFO_WR_WIDTH_Msk           (0x00030000u)   /* DATA[17:16]     Transfer width  */

#define CY_SMIF_CMD_MMIO_FIFO_WR_TXDATA_BYTE_2_Pos   (8u)            /* [15:8] */
#define CY_SMIF_CMD_MMIO_FIFO_WR_TXDATA_BYTE_2_Msk   (0x0000FF00u)   /* DATA[15:8] second byte */

#define CY_SMIF_CMD_MMIO_FIFO_WR_TXDATA_BYTE_1_Pos   (0u)            /* [7:0]         first byte         */
#define CY_SMIF_CMD_MMIO_FIFO_WR_TXDATA_BYTE_1_Msk   (0x000000FFu)   /* DATA[7:0]     first byte         */

#define CY_SMIF_CMD_MMIO_FIFO_WR_DUMMY_Pos           (0u)            /* [0]             Dummy count          */
#define CY_SMIF_CMD_MMIO_FIFO_WR_DUMMY_Msk           (0x0000FFFFu)   /* DATA[15:0]      Dummy count          */

#define CY_SMIF_CMD_MMIO_FIFO_WR_TX_COUNT_Msk        (0x0000FFFFu)   /* DATA[15:0]      TX count             */
#define CY_SMIF_CMD_MMIO_FIFO_WR_TX_COUNT_Pos        (0u)            /* [0]             TX count             */

#define CY_SMIF_CMD_MMIO_FIFO_WR_RX_COUNT_Msk        (0x0000FFFFu)   /* DATA[15:0]      RX count             */
#define CY_SMIF_CMD_MMIO_FIFO_WR_RX_COUNT_Pos        (0u)            /* [0]             RX count             */
#else
/* SMIF->TX_CMD_FIFO_WR  */
...
#define CY_SMIF_CMD_FIFO_WR_MODE_Pos            (18u)           /* [19:18]         Command data mode */
#define CY_SMIF_CMD_FIFO_WR_MODE_Msk            (0x000C0000u)   /* DATA[19:18]       Command data mode    */

#define CY_SMIF_CMD_FIFO_WR_WIDTH_Pos           (16u)           /* [17:16]         Transfer width       */
#define CY_SMIF_CMD_FIFO_WR_WIDTH_Msk           (0x00030000u)   /* DATA[17:16]     Transfer width       */

#define CY_SMIF_CMD_FIFO_WR_LAST_BYTE_Pos       (15u)           /* [15]            Last byte            */
#define CY_SMIF_CMD_FIFO_WR_LAST_BYTE_Msk       (0x00008000u)   /* DATA[15]        Last byte            */

#define CY_SMIF_CMD_FIFO_WR_SS_Pos              (8u)            /* [11:8]          Slave select         */
#define CY_SMIF_CMD_FIFO_WR_SS_Msk              (0x00000F00u)   /* DATA[11:8]      Slave select         */

#define CY_SMIF_CMD_FIFO_WR_TXDATA_Pos          (0u)            /* [0]             Transmitted byte     */
#define CY_SMIF_CMD_FIFO_WR_TXDATA_Msk          (0x000000FFu)   /* DATA[7:0]         Transmitted byte     */
#define CY_SMIF_CMD_FIFO_WR_DUMMY_Pos           (0u)            /* [0]             Dummy count          */
#define CY_SMIF_CMD_FIFO_WR_DUMMY_Msk           (0x0000FFFFu)   /* DATA[15:0]      Dummy count          */
#define CY_SMIF_CMD_FIFO_WR_TX_COUNT_Msk        (0x0000FFFFu)   /* DATA[15:0]      TX count             */
#define CY_SMIF_CMD_FIFO_WR_TX_COUNT_Pos        (0u)            /* [0]             TX count             */
#define CY_SMIF_CMD_FIFO_WR_RX_COUNT_Msk        (0x0000FFFFu)   /* DATA[15:0]      RX count             */
#define CY_SMIF_CMD_FIFO_WR_RX_COUNT_Pos        (0u)            /* [0]             RX count             */
#endif /* CY_IP_MXSMIF_VERSION */
...
typedef struct
{
    ...
    uint32_t deselectDelay;     /**<  Specifies the minimum duration of SPI de-selection between SPI transfers:
                                ...
                                *   - "6": 7 clock cycles.
                                *   - "7": 8 clock cycles. */
    uint32_t setupDelay;        /**<  Specifies the duration between "spi_select_out[]" becomes low/'0') to 1st
                                * "spi_clk_out" edge:
    ...
    uint32_t holdDelay;         /**< Specifies the duration between last "spi_clk_out" edge to "spi_select_out[]" becomes high/'1'):
                                * "0": 0 memory interface clock cycles + min. duration (see below).
                                * "1": 1 memory interface clock cycle   + min. duration (see below).
                                * "2": 2 memory interface clock cycles + min. duration (see below).
                                * "3": 3 memory interface clock cycles + min. duration (see below).
...
} cy_smif_transmit_command_params_t;
#endif
...
#ifdef SMIF_BTFW_CHANGES
#ifdef TZ_ACTIVE
#define Cy_SMIF_CacheInvalidate(A) secure_call_Cy_SMIF_CacheInvalidate(A)
cy_en_smif_status_t Cy_SMIF_CacheInvalidate(cy_en_smif_cache_t cacheType);
#define Cy_SMIF_DeviceTransferMergingEnable(A,B) secure_call_Cy_SMIF_DeviceTransferMergingEnable(A,B)
void Cy_SMIF_DeviceTransferMergingEnable(SMIF_DEVICE_Type *device, cy_en_smif_merge_timeout_t timeout);
#define Cy_SMIF_Enable(A) secure_call_Cy_SMIF_Enable(A)
void Cy_SMIF_Enable(cy_stc_smif_context_t *context);
#define Cy_SMIF_Encrypt(A,B,C,D) secure_call_Cy_SMIF_Encrypt(A,B,C,D)
cy_en_smif_status_t  Cy_SMIF_Encrypt(uint32_t address,
                               uint8_t data[],
                               uint32_t size,
                               cy_stc_smif_context_t const *context);
#define Cy_SMIF_GetDeviceBySlot(A) secure_call_Cy_SMIF_GetDeviceBySlot(A)
SMIF_DEVICE_Type volatile * Cy_SMIF_GetDeviceBySlot(cy_en_smif_slave_select_t slaveSelect);
#define Cy_SMIF_GetMode secure_call_Cy_SMIF_GetMode
cy_en_smif_mode_t Cy_SMIF_GetMode(void);
#define Cy_SMIF_Init(A,B,C) secure_call_Cy_SMIF_Init(A,B,C)
cy_en_smif_status_t Cy_SMIF_Init(cy_stc_smif_config_t const *config,
                               uint32_t timeout,
                               cy_stc_smif_context_t *context);
#define Cy_SMIF_SetCryptoEnable(A) secure_call_Cy_SMIF_SetCryptoEnable(A)
cy_en_smif_status_t Cy_SMIF_SetCryptoEnable(cy_en_smif_slave_select_t slaveId);
#define Cy_SMIF_SetCryptoDisable(A) secure_call_Cy_SMIF_SetCryptoDisable(A)
cy_en_smif_status_t Cy_SMIF_SetCryptoDisable(cy_en_smif_slave_select_t slaveId);
#define Cy_SMIF_SetCryptoKey(A) secure_call_Cy_SMIF_SetCryptoKey(A)
void Cy_SMIF_SetCryptoKey(uint32_t *key);
#define Cy_SMIF_SetDataSelect(A,B) secure_call_Cy_SMIF_SetDataSelect(A,B)
void Cy_SMIF_SetDataSelect(cy_en_smif_slave_select_t slaveSelect,
                               cy_en_smif_data_select_t dataSelect);
#define Cy_SMIF_SetMode(A)  secure_call_Cy_SMIF_SetMode(A)
void Cy_SMIF_SetMode(cy_en_smif_mode_t mode);
#define Cy_SMIF_BusyCheck  secure_call_Cy_SMIF_BusyCheck
BOOL8 Cy_SMIF_BusyCheck(void);
#define Cy_SMIF_GetCmdFifoStatus secure_call_Cy_SMIF_GetCmdFifoStatus
uint32_t  Cy_SMIF_GetCmdFifoStatus(void);
#define Cy_SMIF_PushTxFifo(A) secure_call_Cy_SMIF_PushTxFifo(A)
void Cy_SMIF_PushTxFifo(cy_stc_smif_context_t *context);      /**< Writes transmitted data into the FIFO. */
#define Cy_SMIF_PopRxFifo(A) secure_call_Cy_SMIF_PopRxFifo(A)
void Cy_SMIF_PopRxFifo(cy_stc_smif_context_t *context);       /**< Reads received data from the FIFO. */
#define Cy_SMIF_SendDummyCycles(A)  secure_call_Cy_SMIF_SendDummyCycles(A)
cy_en_smif_status_t Cy_SMIF_SendDummyCycles(uint32_t cycles);
#define Cy_SMIF_SendDummyCycles_Ext(A,B,C)  secure_call_Cy_SMIF_SendDummyCycles_Ext(A,B,C)
cy_en_smif_status_t Cy_SMIF_SendDummyCycles_Ext(cy_en_smif_txfr_width_t transferWidth,
                                               cy_en_smif_data_rate_t dataRate,
                                               uint32_t cycles);
#define Cy_SMIF_TransmitCommand_ExtSecure(A) secure_call_Cy_SMIF_TransmitCommand_ExtSecure(A)
cy_en_smif_status_t Cy_SMIF_TransmitCommand_ExtSecure(cy_smif_transmit_command_params_t *transmit_command_params);
#define Cy_SMIF_UpdateTxClockMode(A) secure_call_Cy_SMIF_UpdateTxClockMode(A)
void Cy_SMIF_UpdateTxClockMode(UINT32 dataDataRate);
#define Cy_SMIF_ReceiveDataBlocking_Ext_Secure(A,B,C) secure_call_Cy_SMIF_ReceiveDataBlocking_Ext_Secure(A,B,C)
void Cy_SMIF_ReceiveDataBlocking_Ext_Secure(cy_en_smif_data_rate_t dataRate, cy_en_smif_txfr_width_t transferWidth, uint32_t rxUnitNum);
#define Cy_SMIF_TransmitDataBlocking_Ext_Secure(A,B,C) secure_call_Cy_SMIF_TransmitDataBlocking_Ext_Secure(A,B,C)
void Cy_SMIF_TransmitDataBlocking_Ext_Secure(cy_en_smif_data_rate_t dataDataRate, cy_en_smif_txfr_width_t transferWidth, uint32_t  trUnitNum);
#define Cy_SMIF_DeviceControlDataSelect(A,B) secure_call_Cy_SMIF_DeviceControlDataSelect(A,B)
void Cy_SMIF_DeviceControlDataSelect(SMIF_DEVICE_Type volatile* device, cy_en_smif_data_select_t dataSelect);
#define Cy_SMIF_IsCtlModeXip secure_call_Cy_SMIF_IsCtlModeXip
BOOL32 Cy_SMIF_IsCtlModeXip(void);
#define Cy_SMIF_SaveHwRegs(A) secure_call_Cy_SMIF_SaveHwRegs(A)
#if 1 // fixme_bfn this should be moved to different file so don't need to include cy_smif_flash.h
...
cy_en_smif_status_t  Cy_SMIF_Encrypt(SMIF_Type *base,
                                ...
                                uint32_t size,
                                cy_stc_smif_context_t const *context);
SMIF_DEVICE_Type volatile * Cy_SMIF_GetDeviceBySlot(SMIF_Type *base,
                                cy_en_smif_slave_select_t slaveSelect);
...
void Cy_SMIF_PushTxFifo(SMIF_Type *baseaddr, cy_stc_smif_context_t *context);      /**< Writes transmitted data into the FIFO. */
void Cy_SMIF_PopRxFifo(SMIF_Type *baseaddr, cy_stc_smif_context_t *context);       /**< Reads received data from the FIFO. */
...
cy_en_smif_status_t  Cy_SMIF_ReceiveDataBlocking(SMIF_Type *base,
                                ...
                                cy_stc_smif_context_t const *context);
#ifdef SMIF_BTFW_CHANGES
uint32_t Cy_SMIF_GetTransferStatus(cy_stc_smif_context_t const *context);
#else
...
cy_en_smif_status_t Cy_SMIF_ReceiveDataBlocking_Ext(SMIF_Type *base,
                                                ...
                                                cy_stc_smif_context_t const *context);
#ifdef SMIF_BTFW_CHANGES
cy_en_smif_status_t Cy_SMIF_WaitForSafeState(uint32_t timeout);
cy_en_smif_status_t Cy_SMIF_SetModeWithBusyCheck(cy_en_smif_mode_t mode, uint32_t timeout);

#endif

#ifdef SMIF_BTFW_CHANGES
void Cy_SMIF_Disable(SMIF_Type *base);
void  Cy_SMIF_SetInterruptMask(SMIF_Type *base, uint32_t interrupt);
uint32_t  Cy_SMIF_GetInterruptMask(SMIF_Type const *base);
uint32_t  Cy_SMIF_GetInterruptStatusMasked(SMIF_Type const *base);
uint32_t  Cy_SMIF_GetInterruptStatus(SMIF_Type const *base);
void  Cy_SMIF_SetInterrupt(SMIF_Type *base, uint32_t interrupt);
void  Cy_SMIF_ClearInterrupt(SMIF_Type *base, uint32_t interrupt);
void  Cy_SMIF_SetTxFifoTriggerLevel(SMIF_Type *base, uint32_t level);
void  Cy_SMIF_SetRxFifoTriggerLevel(SMIF_Type *base, uint32_t level);
uint32_t  Cy_SMIF_GetTxFifoStatus(SMIF_Type const *base);
uint32_t  Cy_SMIF_GetRxFifoStatus(SMIF_Type const *base);
#endif
...
/** \cond INTERNAL */
#ifdef SMIF_BTFW_CHANGES
uint32_t Cy_SMIF_UnsecurePackBytesArray(uint8_t const buff[], BOOL8 fourBytes);
#endif
uint32_t Cy_SMIF_PackBytesArray(uint8_t const buff[], BOOL8 fourBytes);
void Cy_SMIF_UnPackByteArray(uint32_t inValue, uint8_t outBuff[], BOOL8 fourBytes);
cy_en_smif_status_t Cy_SMIF_TimeoutRun(uint32_t *timeoutUnits);
#ifdef SMIF_BTFW_CHANGES
cy_en_smif_status_t Cy_SMIF_UnsecureTimeoutRun(uint32_t *timeoutUnits);
#endif
/** \endcond */
...
cy_en_smif_status_t  Cy_SMIF_Encrypt(SMIF_Type *base,
                                ...
                                uint32_t size,
                                cy_stc_smif_context_t const *context);
__STATIC_INLINE BOOL8 Cy_SMIF_BusyCheck(SMIF_Type const *base);
...
__STATIC_INLINE uint32_t Cy_SMIF_PackBytesArray(uint8_t const buff[], BOOL8 fourBytes);
__STATIC_INLINE void Cy_SMIF_UnPackByteArray(uint32_t inValue, uint8_t outBuff[], BOOL8 fourBytes);
...
__STATIC_INLINE BOOL8 Cy_SMIF_BusyCheck(SMIF_Type const *base)
{
  return (1u == _FLD2VAL(SMIF_STATUS_BUSY, SMIF_STATUS(base)));
}
...
__STATIC_INLINE uint32_t Cy_SMIF_PackBytesArray(uint8_t const buff[], BOOL8 fourBytes)
{
    ...
    result = ((uint32_t)buff[1u] << 8u) | (uint32_t)buff[0u];

    if(fourBytes)
    {
        result |= ((uint32_t)buff[3u] << 24u) | ((uint32_t)buff[2u] << 16u);
    }
...
__STATIC_INLINE void Cy_SMIF_UnPackByteArray(uint32_t inValue, uint8_t outBuff[], BOOL8 fourBytes)
{
    outBuff[0u] = (uint8_t)(inValue & 0xFFu);
    outBuff[1u] = (uint8_t)((inValue >> 8u ) & 0xFFu);

    if(fourBytes)
    {
        outBuff[2u] = (uint8_t)((inValue >> 16u) & 0xFFu);
        outBuff[3u] = (uint8_t)((inValue >> 24u) & 0xFFu);
    }
}
...
__STATIC_INLINE cy_en_smif_status_t Cy_SMIF_TimeoutRun(uint32_t *timeoutUnits)
{
    ...
    if (*timeoutUnits > 0u)
    {
        Cy_SysLib_Boot_DelayUs(CY_SMIF_WAIT_1_UNIT);
        --(*timeoutUnits);
