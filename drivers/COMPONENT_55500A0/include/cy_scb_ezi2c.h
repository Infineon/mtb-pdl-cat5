...
typedef struct cy_stc_scb_ezi2c_context
{
    ...
    BOOL8     addr1Active; /**< Defines whether the request is intended for the primary slave address */
...
*/
#define CY_SCB_EZI2C_STATUS_READ1       (0x01u)
...
* transfer was completed successfully.
*/
#define CY_SCB_EZI2C_STATUS_READ2       (0x04u)
...
* transfer was completed successfully.
*/
#define CY_SCB_EZI2C_STATUS_WRITE2       (0x08u)
...
*/
#define CY_SCB_EZI2C_STATUS_BUSY        (0x10u)
...
*/
#define CY_SCB_EZI2C_STATUS_ERR         (0x20u)
...
*/
#define CY_SCB_EZI2C_DEFAULT_TX  (0xFFu)
...
#define CY_SCB_EZI2C_HALF_FIFO_SIZE    (CY_SCB_FIFO_SIZE / 2u)

#define CY_SCB_EZI2C_ONE_ADDRESS_MASK   (0xFFu)
