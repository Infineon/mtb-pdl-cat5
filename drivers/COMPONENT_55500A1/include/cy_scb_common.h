...
__STATIC_INLINE BOOL8     Cy_SCB_IsTxComplete  (CySCB_Type const *base);
__STATIC_INLINE void     Cy_SCB_ClearTxFifo   (CySCB_Type *base);

__STATIC_INLINE void     Cy_SCB_SetByteMode(CySCB_Type *base, BOOL8 byteMode);
...
__STATIC_INLINE BOOL8     Cy_SCB_IsRxDataWidthByte(CySCB_Type const *base);
__STATIC_INLINE BOOL8     Cy_SCB_IsTxDataWidthByte(CySCB_Type const *base);
...
#define CY_SCB_SUB_MODE_Pos (13u)

/** EZI2C mode identifier */
#define CY_SCB_EZI2C_ID     (0x0u << CY_SCB_SUB_MODE_Pos)

/** EZI2C mode identifier */
#define CY_SCB_I2C_ID       (0x1u << CY_SCB_SUB_MODE_Pos)

/** EZI2C mode identifier */
#define CY_SCB_SPI_ID       (0x2u << CY_SCB_SUB_MODE_Pos)

/** EZI2C mode identifier */
#define CY_SCB_UART_ID      (0x3u << CY_SCB_SUB_MODE_Pos)
...
#define CY_SCB_CTRL_DEF_VAL         (_VAL2FLD(SCB_CTRL_OVS, 15u) | \
                                     _VAL2FLD(SCB_CTRL_MODE, 3u))

#define CY_SCB_I2C_CTRL_DEF_VAL     (_VAL2FLD(SCB_I2C_CTRL_HIGH_PHASE_OVS, 8u)        | \
                                     _VAL2FLD(SCB_I2C_CTRL_HIGH_PHASE_OVS, 8u)        | \
                                     _VAL2FLD(SCB_I2C_CTRL_M_READY_DATA_ACK, 1u)      | \
                                     _VAL2FLD(SCB_I2C_CTRL_M_NOT_READY_DATA_NACK, 1u) | \
                                     _VAL2FLD(SCB_I2C_CTRL_S_GENERAL_IGNORE, 1u)      | \
                                     _VAL2FLD(SCB_I2C_CTRL_S_READY_ADDR_ACK, 1u)      | \
                                     _VAL2FLD(SCB_I2C_CTRL_S_READY_DATA_ACK, 1u)      | \
                                     _VAL2FLD(SCB_I2C_CTRL_S_NOT_READY_ADDR_NACK, 1u) | \
                                     _VAL2FLD(SCB_I2C_CTRL_S_NOT_READY_DATA_NACK, 1u))

#define CY_SCB_I2C_CFG_DEF_VAL      (_VAL2FLD(SCB_I2C_CFG_SDA_IN_FILT_TRIM, 3u)   | \
                                     _VAL2FLD(SCB_I2C_CFG_SDA_IN_FILT_SEL, 1u)    | \
                                     _VAL2FLD(SCB_I2C_CFG_SCL_IN_FILT_SEL, 1u)    | \
                                     _VAL2FLD(SCB_I2C_CFG_SDA_OUT_FILT0_TRIM, 2u) | \
                                     _VAL2FLD(SCB_I2C_CFG_SDA_OUT_FILT1_TRIM, 2u) | \
                                     _VAL2FLD(SCB_I2C_CFG_SDA_OUT_FILT2_TRIM, 2u))

#define CY_SCB_SPI_CTRL_DEF_VAL     _VAL2FLD(SCB_SPI_CTRL_MODE, 3u)
#define CY_SCB_UART_CTRL_DEF_VAL    _VAL2FLD(SCB_UART_CTRL_MODE, 3u)

#define CY_SCB_UART_RX_CTRL_DEF_VAL (_VAL2FLD(SCB_UART_RX_CTRL_STOP_BITS, 2u) | \
                                     _VAL2FLD(SCB_UART_RX_CTRL_BREAK_WIDTH, 10u))

#define CY_SCB_UART_TX_CTRL_DEF_VAL _VAL2FLD(SCB_UART_TX_CTRL_STOP_BITS, 2u)

#define CY_SCB_RX_CTRL_DEF_VAL      (_VAL2FLD(SCB_RX_CTRL_DATA_WIDTH, 7u) | \
                                     _VAL2FLD(SCB_RX_CTRL_MSB_FIRST,  1u))

#define CY_SCB_TX_CTRL_DEF_VAL      (_VAL2FLD(SCB_TX_CTRL_DATA_WIDTH, 7u) | \
                                     _VAL2FLD(SCB_TX_CTRL_MSB_FIRST,  1u))

/* SCB CTRL modes */
#define CY_SCB_CTRL_MODE_I2C   (0u)
#define CY_SCB_CTRL_MODE_SPI   (1u)
#define CY_SCB_CTRL_MODE_UART  (2u)
...
*/
#define CY_SCB_I2C_CFG_CLK_ENABLE_Msk  (_VAL2FLD(SCB_I2C_CFG_SDA_IN_FILT_TRIM, 2u))

/* I2C has fixed data width */
#define CY_SCB_I2C_DATA_WIDTH   (7u)
...
#define CY_SCB_I2C_ADDRESS_Pos  (1u)
#define CY_SCB_I2C_ADDRESS_Msk  (0xFEu)
...
/* Max number of bits for nibble mode */
#define CY_SCB_NIBBLE_WIDTH (4u)

/* Max number of bits for byte mode */
#define CY_SCB_BYTE_WIDTH   (8u)

#if(CY_IP_MXSCB_VERSION>=3)
/* Max number of bits for HALF WORD mode */
#define CY_SCB_HALF_WORD_WIDTH   (16u)

/* Max number of bits for WORD mode */
#define CY_SCB_WORD_WIDTH   (32u)

/*SCB Mem width modes */
#define CY_SCB_MEM_WIDTH_BYTE   (0u)
#define CY_SCB_MEM_WIDTH_HALFWORD   (1u)
#define CY_SCB_MEM_WIDTH_WORD   (2u)
#endif /* CY_IP_MXSCB_VERSION */
...
#define CY_SCB_CLEAR_ALL_INTR_SRC   (0u)

/* Hardware FIFO size: EZ_DATA_NR / 4 = (512 / 4) = 128 */
#define CY_SCB_FIFO_SIZE            (SCB_IP_FIFO_SIZE)
...
#define CY_SCB_IS_INTR_VALID(intr, mask)            ( 0u == ((intr) & ((uint32_t) ~(mask))) )
...
#define CY_SCB_IS_BUFFER_VALID(buffer, size)        ( (NULL != (buffer)) && ((size) > 0u) )
#define CY_SCB_IS_I2C_BUFFER_VALID(buffer, size)    ( (0u == (size)) ? TRUE : (NULL != (buffer)) )
/** \endcond */
...
__STATIC_INLINE BOOL8 Cy_SCB_IsTxComplete(CySCB_Type const *base)
{
     return (0u == (Cy_SCB_GetNumInTxFifo(base) + Cy_SCB_GetTxSrValid(base)));
}
...
#elif(CY_IP_MXSCB_VERSION==1)
    {return (_FLD2BOOL(SCB_CTRL_BYTE_MODE, SCB_CTRL(base)) ? (CY_SCB_FIFO_SIZE) : (CY_SCB_FIFO_SIZE / 2u));}
#endif /* CY_IP_MXSCB_VERSION */
}
...
__STATIC_INLINE uint32_t Cy_SCB_Get_RxDataWidth(CySCB_Type const *base)
{
    return (_FLD2VAL(SCB_RX_CTRL_DATA_WIDTH, SCB_RX_CTRL(base)) + 1u);
}
#endif /* CY_IP_MXSCB_VERSION */
...
__STATIC_INLINE uint32_t Cy_SCB_Get_TxDataWidth(CySCB_Type const *base)
{
        return (_FLD2VAL(SCB_TX_CTRL_DATA_WIDTH, SCB_TX_CTRL(base)) + 1u);
}
#endif /* CY_IP_MXSCB_VERSION */
...
__STATIC_INLINE void Cy_SCB_FwBlockReset(CySCB_Type *base)
{
    ...
    SCB_I2C_M_CMD(base) = 0u;
    SCB_I2C_S_CMD(base) = 0u;
