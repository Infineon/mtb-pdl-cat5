...
typedef enum 
{
    CY_TDM_SUCCESS          = 0x00u,                                     /**< Successful. */
    CY_TDM_BAD_PARAM        = CY_TDM_ID | CY_PDL_STATUS_ERROR | 0x01u  /**< One or more invalid parameters. */
} cy_en_tdm_status_t;

/** cy_en_tdm_source_status_t */
typedef enum 
{
    CY_TDM_OK                = 0x00u, /**< Successful. */
    CY_TDM_BAD               = 0x01u  /**< Not Good    */
} cy_en_tdm_source_status_t;
...
typedef struct
{
    BOOL8                       enable;               /**<  Enables/Disables TDM TX */
    ...
    BOOL8                       i2sMode;              /**<  IF set to 1 the IP is configured for I2S mode else for TDM mode    */
}cy_stc_tdm_config_tx_t;

/** cy_stc_tdm_config_rx_t */
typedef struct
{
    BOOL8                       enable;               /**<  Enables/Disables TDM RX */
    cy_en_tdm_device_cfg_t      masterMode;           /**<  Master mode/Slave mode configuration. \ref cy_en_tdm_device_cfg_t */
    ...
    BOOL8                       lateSample;           /**<  Interface late sample delay.
...
/** TDM Macro */
#define CY_TDM_IS_CHANNELS_VALID(channels)   (((channels) > 0u) && ((channels) <= 31u))
/** TDM Macro */
#define CY_TDM_IS_CHANNEL_SIZE_VALID(channel_size)   (((channel_size) > 2u) && ((channel_size) <= 31u))
/** TDM Macro */
#define CY_I2S_TDM_INTR_TX_MASK_VALID(interrupt) (0u == ((interrupt) & ((uint32_t) ~CY_TDM_INTR_TX_MASK)))
/** TDM Macro */
#define CY_I2S_TDM_INTR_RX_MASK_VALID(interrupt) (0u == ((interrupt) & ((uint32_t) ~CY_TDM_INTR_RX_MASK)))
/** TDM Macro */
#define CY_I2S_TDM_IS_INPUT_SIGNAL_MODE_VALID(signalInput)   (signalInput <= 2u)
