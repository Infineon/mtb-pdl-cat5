...
typedef struct cy_stc_tcpwm_counter_config
{
    ...
    BOOL8        enableCompareSwap;  /**< If enabled, the compare values are swapped each time the comparison is TRUE */
    ...
    BOOL8        enableCompare1Swap; /**< If enabled, the compare1 values are swapped each time the comparison is TRUE */
...
* The counter status.
*/
#define CY_TCPWM_COUNTER_STATUS_DOWN_COUNTING   (0x1u)        /**< Timer/Counter is down counting */
#define CY_TCPWM_COUNTER_STATUS_UP_COUNTING     (0x2u)        /**< Timer/Counter is up counting */
...
__STATIC_INLINE void Cy_TCPWM_Counter_EnableCompare0Swap(TCPWM_Type *base, uint32_t cntNum, BOOL8 enable);
...
__STATIC_INLINE void Cy_TCPWM_Counter_EnableCompare1Swap(TCPWM_Type *base, uint32_t cntNum,  BOOL8 enable);
#endif
