...
typedef struct cy_stc_tcpwm_shiftreg_config
{
    ...
    BOOL8        enableCompare0Swap; /**< If enabled, the compare 0 values are swapped on the terminal count. */
...
*/
#define CY_TCPWM_SHIFTREG_STATUS_RUNNING (0x00008000u) /**< Shift Register is running */
