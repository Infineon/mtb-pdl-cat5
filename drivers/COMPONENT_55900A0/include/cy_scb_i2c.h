...
{
    /** \cond INTERNAL */
    BOOL8 useRxFifo;             /**< Stores RX FIFO configuration */
    BOOL8 useTxFifo;             /**< Stores TX FIFO configuration */

    volatile uint32_t state;    /**< The driver state */

    volatile uint32_t masterStatus; /**< The master status */
    BOOL8     masterPause;           /**< Stores how the master ends the transaction */
    BOOL8     masterRdDir;           /**< The direction of the master transaction */
    ...
    volatile BOOL8     slaveRdBufEmpty;   /**< Tracks slave Read buffer empty event */
...
#define CY_SCB_I2C_MASTER_WR_CMPLT_EVENT       (0x00020000u)

/** The master read started by \ref Cy_SCB_I2C_MasterRead is complete */
#define CY_SCB_I2C_MASTER_RD_CMPLT_EVENT       (0x00040000u)
...
*/
#define CY_SCB_I2C_MASTER_ERR_EVENT            (0x00080000u)
...
*/
#define CY_SCB_I2C_GENERAL_CALL_EVENT      (0x01u)
...
*/
#define CY_SCB_I2C_ADDR_IN_FIFO_EVENT      (0x02u)
...
* Read buffer
*/
#define CY_SCB_I2C_DEFAULT_TX  (0xFFu)
...
#define CY_SCB_I2C_MASTER_TIMEOUT_DONE (0x80000000u)
...
/* I2C states */
#define CY_SCB_I2C_IDLE              (0x10000000u)
#define CY_SCB_I2C_IDLE_MASK         (0x10000000u)

/* Master states */
#define CY_SCB_I2C_MASTER_ACTIVE     (0x00100000u)
#define CY_SCB_I2C_MASTER_WAIT       (0x10100000u)
#define CY_SCB_I2C_MASTER_RX0        (0x00110000u)
#define CY_SCB_I2C_MASTER_RX1        (0x00120000u)
#define CY_SCB_I2C_MASTER_ADDR       (0x10130000u)
#define CY_SCB_I2C_MASTER_TX         (0x00140000u)
#define CY_SCB_I2C_MASTER_TX_DONE    (0x00150000u)
#define CY_SCB_I2C_MASTER_STOP       (0x00160000u)
#define CY_SCB_I2C_MASTER_WAIT_STOP  (0x00170000u)
#define CY_SCB_I2C_MASTER_CMPLT      (0x00180000u)

/* Slave states */
#define CY_SCB_I2C_SLAVE_ACTIVE      (0x00001000u)
#define CY_SCB_I2C_SLAVE_RX_MASK     (0x00001001u)
#define CY_SCB_I2C_SLAVE_RX          (0x00001001u)
#define CY_SCB_I2C_SLAVE_TX          (0x00001002u)

/* FIFO size */
#define CY_SCB_I2C_FIFO_SIZE          CY_SCB_FIFO_SIZE
#define CY_SCB_I2C_HALF_FIFO_SIZE     (CY_SCB_FIFO_SIZE / 2u)

#define CY_SCB_I2C_DEFAULT_RETURN    (0xFFu)

/* Convert the timeout in milliseconds to microseconds */
#define CY_SCB_I2C_CONVERT_TIMEOUT_TO_US(timeoutMs)     ((timeoutMs) * 1000u)
...
#define CY_SCB_I2C_IS_DATA_RATE_VALID(dataRateHz)   ( ((dataRateHz) > 0u) && \
                                                      ((dataRateHz) <= CY_SCB_I2C_FSTP_DATA_RATE) )

#define CY_SCB_I2C_IS_TIMEOUT_VALID(timeoutMs)              ( (timeoutMs) <= (0xFFFFFFFFu / 1000u) )
#define CY_SCB_I2C_IS_LOW_PHASE_CYCLES_VALID(clockCycles)   ( ((clockCycles) >= 7u) && ((clockCycles) <= 16u) )
#define CY_SCB_I2C_IS_HIGH_PHASE_CYCLES_VALID(clockCycles)  ( ((clockCycles) >= 5u) && ((clockCycles) <= 16u) )
...
__STATIC_INLINE void Cy_SCB_I2C_SlaveSetAddress(CySCB_Type *base, uint8_t addr)
{
    ...
    CY_REG32_CLR_SET(SCB_RX_MATCH(base), SCB_RX_MATCH_ADDR, ((uint32_t)((uint32_t) addr << 1u)));
}
...
__STATIC_INLINE uint32_t Cy_SCB_I2C_SlaveGetAddress(CySCB_Type const *base)
{
    return (_FLD2VAL(SCB_RX_MATCH_ADDR, SCB_RX_MATCH(base)) >> 1u);
}
...
__STATIC_INLINE void Cy_SCB_I2C_MasterSetLowPhaseDutyCycle(CySCB_Type *base, uint32_t clockCycles)
{
    ...
    CY_REG32_CLR_SET(SCB_I2C_CTRL(base), SCB_I2C_CTRL_LOW_PHASE_OVS, (clockCycles - 1u));
}
...
__STATIC_INLINE void Cy_SCB_I2C_MasterSetHighPhaseDutyCycle(CySCB_Type *base, uint32_t clockCycles)
{
    ...
    CY_REG32_CLR_SET(SCB_I2C_CTRL(base), SCB_I2C_CTRL_HIGH_PHASE_OVS, (clockCycles - 1u));
}
/** \} group_scb_i2c_general_functions */
