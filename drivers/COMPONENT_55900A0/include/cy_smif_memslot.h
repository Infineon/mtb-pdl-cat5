...
#ifdef SMIF_BTFW_CHANGES
// Want to know if DTR supported, but don't want to use it during boot since
// there may be data integrity issues.  If it is supported, may switch to
// after boot.
#define CY_SMIF_FLAG_DTR_SUPPORTED    (64U)
#endif // SMIF_BTFW_CHANGES
...
#define CY_SMIF_NO_COMMAND_OR_MODE                  (0xFFFFFFFFu)          /**< No command or mode present */
#define CY_SMIF_SFDP_QE_BIT_1_OF_SR_2               (0x02u)                /**< The QE is bit 1 of the status register 2 */
#define CY_SMIF_SFDP_QE_BIT_6_OF_SR_1               (0x40u)                /**< The QE is bit 6 of the status register 1 */
#define CY_SMIF_SFDP_QE_BIT_7_OF_SR_2               (0x80u)                /**< The QE is bit 7 of the status register 2 */
...
#define CY_SMIF_SFDP_SECTOR_MAP_CMD_OFFSET          (1u)    /**< The offset for the detection command instruction in the Sector Map command descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_ADDR_LEN_OFFSET     (2u)    /**< The offset for the detection command address length in the Sector Map command descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_REG_MSK_OFFSET      (3u)    /**< The offset for the read data mask in the Sector Map command descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_REG_ADDR_OFFSET     (4u)    /**< The offset for the detection command address in the Sector Map command descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_REGION_COUNT_OFFSET (2u)    /**< The offset for the regions count in the Sector Map descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_CONFIG_ID_OFFSET    (2u)    /**< The offset for the configuration ID in the Sector Map descriptor */
...
#define CY_SMIF_SFDP_SECTOR_MAP_ADDR_BYTES_Msk      (0xC0u) /**< The mask for the configuration detection command address bytes in the Sector Map descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_ADDR_BYTES_Pos      (6u)    /**< The position of the configuration detection command address bytes in the Sector Map descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_DUMMY_CYCLES_Msk    (0xFu)  /**< The mask for the configuration detection command read latency cycles in the Sector Map descriptor */
#define CY_SMIF_SFDP_SECTOR_MAP_DUMMY_CYCLES_Pos    (0u)    /**< The position of the configuration detection command read latency cycles in the Sector Map descriptor */
...
/* ----------------------------  1st DWORD  ---------------------------- */
#define CY_SMIF_SFDP_FAST_READ_1_1_4_Pos            (6u)                   /**< The SFDP 1-1-4 fast read support (Bit 6)               */
#define CY_SMIF_SFDP_FAST_READ_1_1_4_Msk            (0x40u)                /**< The SFDP 1-1-4 fast read support (Bitfield-Mask: 0x01) */
#define CY_SMIF_SFDP_FAST_READ_1_4_4_Pos            (5u)                   /**< The SFDP 1-4-4 fast read support (Bit 5)               */
#define CY_SMIF_SFDP_FAST_READ_1_4_4_Msk            (0x20u)                /**< The SFDP 1-4-4 fast read support (Bitfield-Mask: 0x01) */
#define CY_SMIF_SFDP_FAST_READ_1_2_2_Pos            (4u)                   /**< The SFDP 1-2-2 fast read support (Bit 4)               */
#define CY_SMIF_SFDP_FAST_READ_1_2_2_Msk            (0x10u)                /**< The SFDP 1-2-2 fast read support (Bitfield-Mask: 0x01) */
...
* This macro is available for CAT1B, CAT1C and CAT1D devices.
**/
#define CY_SMIF_SFDP_DTR_SUPPORT_Pos                  (3u)                   /**< The SFDP DTR support (Bit 3)                           */
/**
* \note
* This macro is available for CAT1B, CAT1C and CAT1D devices.
**/
#define CY_SMIF_SFDP_DTR_SUPPORT_Msk                  (0x08u)                /**< The SFDP DTR support (Bitfield-Mask: 0x08)             */
#endif /* CY_IP_MXSMIF_VERSION */

#define CY_SMIF_SFDP_ADDRESS_BYTES_Pos              (1u)                   /**< The SFDP number of address bytes (Bit 1)               */
#define CY_SMIF_SFDP_ADDRESS_BYTES_Msk              (0x06u)                /**< The SFDP number of address bytes (Bitfield-Mask: 0x03) */
#define CY_SMIF_SFDP_FAST_READ_1_1_2_Pos            (0u)                   /**< The SFDP 1-1-2 fast read support (Bit 0)               */
#define CY_SMIF_SFDP_FAST_READ_1_1_2_Msk            (0x01u)                /**< The SFDP 1-1-2 fast read support (Bitfield-Mask: 0x01) */

/* ----------------------------  2nd DWORD  ---------------------------- */
#define CY_SMIF_SFDP_SIZE_ABOVE_4GB_Msk             (0x80000000u)          /**< Flash memory density bit define if it >= 4 Gbit  or <= 2Gbit */

/* ----------------------------  3rd DWORD  ---------------------------- */
#define CY_SMIF_SFDP_1_4_4_DUMMY_CYCLES_Pos         (0u)                   /**< The SFDP number of 1-4-4 fast read dummy cycles (Bit 0)               */
#define CY_SMIF_SFDP_1_4_4_DUMMY_CYCLES_Msk         (0x1Fu)                /**< The SFDP number of 1-4-4 fast read dummy cycles (Bitfield-Mask: 0x1F) */
#define CY_SMIF_SFDP_1_4_4_MODE_CYCLES_Pos          (5u)                   /**< The SFDP number of 1-4-4 fast read mode cycles (Bit 5)                */
#define CY_SMIF_SFDP_1_4_4_MODE_CYCLES_Msk          (0xE0u)                /**< The SFDP number of 1-4-4 fast read mode cycles (Bitfield-Mask: 0x07)  */
#define CY_SMIF_SFDP_1_1_4_DUMMY_CYCLES_Pos         (0u)                   /**< The SFDP number of 1-1-4 fast read dummy cycles (Bit 0)               */
#define CY_SMIF_SFDP_1_1_4_DUMMY_CYCLES_Msk         (0x1Fu)                /**< The SFDP number of 1-1-4 fast read dummy cycles (Bitfield-Mask: 0x1F) */
#define CY_SMIF_SFDP_1_1_4_MODE_CYCLES_Pos          (5u)                   /**< The SFDP number of 1-1-4 fast read mode cycles (Bit 5)                */
#define CY_SMIF_SFDP_1_1_4_MODE_CYCLES_Msk          (0xE0u)                /**< The SFDP number of 1-1-4 fast read mode cycles (Bitfield-Mask: 0x07)  */

/* ----------------------------  4th DWORD  ---------------------------- */
#define CY_SMIF_SFDP_1_1_2_DUMMY_CYCLES_Pos         (0u)                   /**< The SFDP number of 1_1_2 fast read dummy cycles (Bit 0)               */
#define CY_SMIF_SFDP_1_1_2_DUMMY_CYCLES_Msk         (0x1Fu)                /**< The SFDP number of 1_1_2 fast read dummy cycles (Bitfield-Mask: 0x1F) */
#define CY_SMIF_SFDP_1_1_2_MODE_CYCLES_Pos          (5u)                   /**< The SFDP number of 1_1_2 fast read mode cycles (Bit 5)                */
#define CY_SMIF_SFDP_1_1_2_MODE_CYCLES_Msk          (0xE0u)                /**< The SFDP number of 1_1_2 fast read mode cycles (Bitfield-Mask: 0x07)  */
#define CY_SMIF_SFDP_1_2_2_DUMMY_CYCLES_Pos         (0u)                   /**< The SFDP number of 1_2_2 fast read dummy cycles (Bit 0)               */
#define CY_SMIF_SFDP_1_2_2_DUMMY_CYCLES_Msk         (0x1Fu)                /**< The SFDP number of 1_2_2 fast read dummy cycles (Bitfield-Mask: 0x1F) */
#define CY_SMIF_SFDP_1_2_2_MODE_CYCLES_Pos          (5u)                   /**< The SFDP number of 1_2_2 fast read mode cycles (Bit 5)                */
#define CY_SMIF_SFDP_1_2_2_MODE_CYCLES_Msk          (0xE0u)                /**< The SFDP number of 1_2_2 fast read mode cycles (Bitfield-Mask: 0x07)  */

/* ----------------------------  10th DWORD  --------------------------- */
#define CY_SMIF_SFDP_ERASE_T1_COUNT_Pos             (4u)                   /**< Erase Type 1 Erase, Typical time: count (Bits 8:4) */
#define CY_SMIF_SFDP_ERASE_T1_COUNT_Msk             (0x1F0u)               /**< Erase Type 1 Erase, Typical time: count (Bitfield-Mask ) */
#define CY_SMIF_SFDP_ERASE_T1_UNITS_Pos             (9u)                   /**< Erase Type 1 Erase, Typical time: units (Bits 10:9) */
#define CY_SMIF_SFDP_ERASE_T1_UNITS_Msk             (0x600u)               /**< Erase Type 1 Erase, Typical time: units (Bitfield-Mask ) */
#define CY_SMIF_SFDP_ERASE_Mu_COUNT_Pos            (0u)                   /**< Multiplier from typical erase time to maximum erase time (Bits 3:0) */
#define CY_SMIF_SFDP_ERASE_Mu_COUNT_Msk            (0x0Fu)                /**< Multiplier from typical erase time to maximum erase time (Bitfield-Mask ) */


/* ----------------------------  11th DWORD  --------------------------- */
#define CY_SMIF_SFDP_PAGE_SIZE_Pos                  (4u)                   /**< The SFDP page size (Bit 4)                                    */
#define CY_SMIF_SFDP_PAGE_SIZE_Msk                  (0xF0u)                /**< The SFDP page size (Bitfield-Mask: 0x0F)                      */
#define CY_SMIF_SFDP_PAGE_PROG_COUNT_Pos            (8u)                   /**< The SFDP Chip Page Program Typical time: count (Bits 12:8)    */
#define CY_SMIF_SFDP_PAGE_PROG_COUNT_Msk            (0x1F00u)              /**< The SFDP Chip Page Program Typical time: count (Bitfield-Mask)*/
#define CY_SMIF_SFDP_PAGE_PROG_UNITS_Pos            (13u)                  /**< The SFDP Chip Page Program Typical time: units (Bit 13)       */
#define CY_SMIF_SFDP_PAGE_PROG_UNITS_Msk            (0x2000u)              /**< The SFDP Chip Page Program Typical time: units (Bitfield-Mask)*/
#define CY_SMIF_SFDP_CHIP_ERASE_COUNT_Pos           (24u)                  /**< The SFDP Chip Erase Typical time: count (Bits 28:24)          */
#define CY_SMIF_SFDP_CHIP_ERASE_COUNT_Msk           (0x1F000000u)          /**< The SFDP Chip Erase Typical time: count (Bitfield-Mask)       */
#define CY_SMIF_SFDP_CHIP_ERASE_UNITS_Pos           (29u)                  /**< The SFDP Chip Erase Typical time: units (Bits 29:30)          */
#define CY_SMIF_SFDP_CHIP_ERASE_UNITS_Msk           (0x60000000u)          /**< The SFDP Chip Erase Typical time: units (Bitfield-Mask)       */
#define CY_SMIF_SFDP_PROG_Mu_COUNT_Pos             (0u)                   /**< Multiplier from typical time to max time for Page or byte program (Bits 3:0)          */
#define CY_SMIF_SFDP_PROG_Mu_COUNT_Msk             (0x0Fu)                /**< Multiplier from typical time to max time for Page or byte program (Bitfield-Mask)       */

/* ----------------------------  15th DWORD  --------------------------- */
#define CY_SMIF_SFDP_QE_REQUIREMENTS_Pos            (4u)                   /**< The SFDP quad enable requirements field (Bit 4)               */
#define CY_SMIF_SFDP_QE_REQUIREMENTS_Msk            (0x70u)                /**< The SFDP quad enable requirements field (Bitfield-Mask: 0x07) */
...
/* ----------------------------  17th DWORD  --------------------------- */
#define CY_SMIF_SFDP_FAST_READ_1_1_8_Pos            (0u)                  /**< The SFDP 1-1-8 fast read support (Bitfield 24:31)               */
#define CY_SMIF_SFDP_FAST_READ_1_1_8_Msk            (0xFFu)          /**< The SFDP 1-1-8 fast read support (Bitfield-Mask: 0xFF) */
#define CY_SMIF_SFDP_1_1_8_MODE_CYCLES_Pos          (5u)                  /**< The SFDP number of 1-1-8 fast read mode cycles (Bitfield 21:23)                */
#define CY_SMIF_SFDP_1_1_8_MODE_CYCLES_Msk          (0xE0u)            /**< The SFDP number of 1-1-8 fast read mode cycles (Bitfield-Mask: 0xE)  */
#define CY_SMIF_SFDP_1_1_8_DUMMY_CYCLES_Pos         (0u)                  /**< The SFDP number of 1_1_8 fast read dummy cycles (Bit 16:19)               */
#define CY_SMIF_SFDP_1_1_8_DUMMY_CYCLES_Msk         (0x1Fu)            /**< The SFDP number of 1_1_8 fast read dummy cycles (Bitfield-Mask: 0x1F) */
#define CY_SMIF_SFDP_FAST_READ_1_8_8_Pos            (0u)                   /**< The SFDP 1-8-8 fast read support (Bitfield 8:15)               */
#define CY_SMIF_SFDP_FAST_READ_1_8_8_Msk            (0xFFu)              /**< The SFDP 1-8-8 fast read support (Bitfield-Mask: 0xFF) */
#define CY_SMIF_SFDP_1_8_8_MODE_CYCLES_Pos          (5u)                   /**< The SFDP number of 1-8-8 fast read mode cycles (Bitfield 5:7)                */
#define CY_SMIF_SFDP_1_8_8_MODE_CYCLES_Msk          (0xE0u)                /**< The SFDP number of 1-8-8 fast read mode cycles (Bitfield-Mask: 0xE)  */
#define CY_SMIF_SFDP_1_8_8_DUMMY_CYCLES_Pos         (0u)                   /**< The SFDP number of 1_8_8 fast read dummy cycles (Bit 0:4)               */
#define CY_SMIF_SFDP_1_8_8_DUMMY_CYCLES_Msk         (0x1Fu)                 /**< The SFDP number of 1_8_8 fast read dummy cycles (Bitfield-Mask: 0x1F) */

/* ----------------------------  19th DWORD  --------------------------- */
#define CY_SMIF_SFDP_OCTAL_ENABE_BIT_Pos            (20u)                  /**< Octal Enable bit present in the flash or not (Bitfiled 20:22)*/
...
/* ----------------------------  1st DWORD  --------------------------- */
#define CY_SMIF_SFDP_OCTAL_DDR_READ_CMD_Pos         (0u)                  /**< Octal DDR 8D-8D-8D read command support position (Bitfield 8:15) */
#define CY_SMIF_SFDP_OCTAL_DDR_READ_CMD_Msk         (0xFFu)               /**< Octal DDR 8D-8D-8D read command support Mask Bitfield-Mask: 0xFF00) */
#define CY_SMIF_SFDP_ODDR_166MHZ_DUMMY_CYCLES_Pos   (27u)                 /**< Octal DDR 8D-8D-8D dummy cycles for 166 Mhz (Bitfield 27:31) */
#define CY_SMIF_SFDP_ODDR_166MHZ_DUMMY_CYCLES_Msk   (0xF8000000u)         /**< Octal DDR 8D-8D-8D dummy cycles for 166 Mhz Mask */
#define CY_SMIF_SFDP_ODDR_200MHZ_DUMMY_CYCLES_Pos   (7u)                  /**< Octal DDR 8D-8D-8D dummy cycles for 200 Mhz (Bitfield 7:11) */
#define CY_SMIF_SFDP_ODDR_200MHZ_DUMMY_CYCLES_Msk   (0xF80u)               /**< Octal DDR 8D-8D-8D dummy cycles for 200 Mhz Mask */
...
typedef struct
{
    ...
    uint8_t* data;
    BOOL8    write;
} cy_stc_smif_reg_access_params_t;

extern const cy_stc_smif_mem_cmd_t cyp_flash_dev_cmd_set_1_readNonVolatileRegCmd;
extern const cy_stc_smif_mem_cmd_t cyp_flash_dev_cmd_set_1_writeRegCmd;

cy_en_smif_status_t Cy_SMIF_Memslot_CmdRegisterAccess(SMIF_Type *base,
                                    cy_stc_smif_mem_config_t const *memDevice,
                                    cy_stc_smif_reg_access_params_t *params,
                                    cy_stc_smif_context_t const *context);

UINT32 Cy_SMIF_Memslot_GetFlashAddress(    cy_stc_smif_mem_config_t const *memConfig, UINT32 address);
#endif
...
cy_en_smif_status_t    Cy_SMIF_MemCmdWriteDisable(SMIF_Type *base,
                                         cy_stc_smif_mem_config_t const *memDevice,
                                         cy_stc_smif_context_t const *context);
BOOL8 Cy_SMIF_MemIsBusy(SMIF_Type *base, cy_stc_smif_mem_config_t const *memDevice,
                                    cy_stc_smif_context_t const *context);
...
cy_en_smif_status_t Cy_SMIF_MemOctalEnable(SMIF_Type *base,
                                    cy_stc_smif_mem_config_t const *memDevice,
                                    cy_stc_smif_context_t const *context);
cy_en_smif_status_t Cy_SMIF_MemOctalDDREnable(SMIF_Type *base,
                                    cy_stc_smif_mem_config_t const *memDevice,
                                    cy_stc_smif_context_t const *context);
#endif
...
cy_en_smif_status_t Cy_SMIF_MemIsQuadEnabled(SMIF_Type *base, cy_stc_smif_mem_config_t const *memConfig,
                                             BOOL8 *isQuadEnabled, cy_stc_smif_context_t const *context);
...
#ifdef SMIF_BTFW_CHANGES
#ifdef TZ_ACTIVE
#define XipRegInit(A,B) secure_call_XipRegInit(A,B)
void XipRegInit(SMIF_DEVICE_Type volatile *dev, cy_stc_smif_mem_config_t const * memCfg);
#define Cy_SMIF_DeviceControlInit(A,B) secure_call_Cy_SMIF_DeviceControlInit(A,B)
void Cy_SMIF_DeviceControlInit(SMIF_DEVICE_Type volatile *device, cy_stc_smif_mem_config_t const * memCfg);
#else // #ifdef TZ_ACTIVE
void XipRegInit(SMIF_DEVICE_Type volatile *dev, cy_stc_smif_mem_config_t const * memCfg);
void Cy_SMIF_DeviceControlInit(SMIF_DEVICE_Type volatile *device, cy_stc_smif_mem_config_t const * memCfg);
#endif // #ifdef TZ_ACTIVE
#else // #ifdef SMIF_BTFW_CHANGES
...
__STATIC_INLINE void XipRegInit(SMIF_DEVICE_Type volatile *dev, cy_stc_smif_mem_config_t const * memCfg)
{
    ...
    SMIF_DEVICE_MASK(dev)= (SMIF_DEVICE_MASK_MASK_Msk & (~(memCfg->memMappedSize) + 1u));

#if (CY_IP_MXSMIF_VERSION>=2)
    SMIF_DEVICE_ADDR_CTL(dev) = _VAL2FLD(SMIF_DEVICE_ADDR_CTL_SIZE3, (devCfg->numOfAddrBytes - 1u)) |
                                ((0u != memCfg->dualQuadSlots)? SMIF_DEVICE_ADDR_CTL_DIV2_Msk: 0u);

    if((memCfg->flags & CY_SMIF_FLAG_SMIF_REV_3) != 0u)
    {
        if(NULL != read)
        {
            ...
            SMIF_DEVICE_RD_DUMMY_CTL(dev) = (0u != read->dummyCycles)?
                                            (_VAL2FLD(SMIF_DEVICE_RD_DUMMY_CTL_SIZE5, (read->dummyCycles - 1u)) |
        ...
        if(NULL != prog)
        {
            ...
            SMIF_DEVICE_WR_DUMMY_CTL(dev) = (0u != prog->dummyCycles) ?
                                            (_VAL2FLD(SMIF_DEVICE_WR_DUMMY_CTL_SIZE5, (prog->dummyCycles - 1u)) |
    ...
    else
    {
        if(NULL != read)
        {
            SMIF_DEVICE_RD_CMD_CTL(dev) = (CY_SMIF_NO_COMMAND_OR_MODE != read->command) ?
                                        (_VAL2FLD(SMIF_DEVICE_RD_CMD_CTL_CODE,    (uint32_t)read->command)  |
                                        _VAL2FLD(SMIF_DEVICE_RD_CMD_CTL_WIDTH, (uint32_t)read->cmdWidth) |
                                        _VAL2FLD(SMIF_DEVICE_RD_CMD_CTL_PRESENT2, 1u))
                                        : 0U;
            ...
            SMIF_DEVICE_RD_MODE_CTL(dev) = (CY_SMIF_NO_COMMAND_OR_MODE != read->mode) ?
                                        (_VAL2FLD(SMIF_DEVICE_RD_MODE_CTL_CODE,  (uint32_t)read->mode)       |
                                            _VAL2FLD(SMIF_DEVICE_RD_MODE_CTL_WIDTH, (uint32_t)read->modeWidth)|
                                            _VAL2FLD(SMIF_DEVICE_RD_MODE_CTL_PRESENT2, 1u))
                                        : 0U;
        ...
        if(NULL != prog)
        {
            SMIF_DEVICE_WR_CMD_CTL(dev) = (CY_SMIF_NO_COMMAND_OR_MODE != prog->command) ?
                                        (_VAL2FLD(SMIF_DEVICE_WR_CMD_CTL_CODE,    (uint32_t)prog->command) |
                                        _VAL2FLD(SMIF_DEVICE_WR_CMD_CTL_WIDTH, (uint32_t)prog->cmdWidth)|
                                        _VAL2FLD(SMIF_DEVICE_WR_CMD_CTL_PRESENT2, 1u))
                                        : 0U;
            ...
            SMIF_DEVICE_WR_MODE_CTL(dev) = (CY_SMIF_NO_COMMAND_OR_MODE != prog->mode) ?
                                            (_VAL2FLD(SMIF_DEVICE_WR_MODE_CTL_CODE,  (uint32_t)prog->mode)       |
                                            _VAL2FLD(SMIF_DEVICE_WR_MODE_CTL_WIDTH, (uint32_t)prog->modeWidth)|
                                            _VAL2FLD(SMIF_DEVICE_WR_MODE_CTL_PRESENT2, 1u))
                                            : 0u;
...
#else
    SMIF_DEVICE_ADDR_CTL(dev) = _VAL2FLD(SMIF_DEVICE_ADDR_CTL_SIZE2, (devCfg->numOfAddrBytes - 1u)) |
                                ((0u != memCfg->dualQuadSlots)? SMIF_DEVICE_ADDR_CTL_DIV2_Msk: 0u);
                                    ...
                                    cy_stc_smif_context_t const *context)
{
    ...
    {
#ifdef SMIF_BTFW_CHANGES
        result = Cy_SMIF_SendDummyCycles(dummyCycles);
#else
