...
#if !defined(CY_TCPWM_COMMON_H)
#define CY_TCPWM_COMMON_H
...
#if (defined(BCM55500) || defined(BCM55900))
#define CY_TCPWM_INPUT_TRIG_14          (16U) /**< Input is connected to the trigger input 14 */
#define CY_TCPWM_INPUT_TRIG_15          (17U) /**< Input is connected to the trigger input 15 */
#define CY_TCPWM_INPUT_TRIG_16          (18U) /**< Input is connected to the trigger input 16 */
#endif
...
__STATIC_INLINE cy_en_tcpwm_status_t Cy_TCPWM_SetDebugFreeze (TCPWM_Type *base, uint32 cntNum, BOOL8 enable);
#endif
/** \cond INTERNAL */
...
__STATIC_INLINE void Cy_TCPWM_Block_EnableCompare0Swap(TCPWM_Type *base, uint32_t cntNum,  BOOL8 enable);
#if (CY_IP_MXTCPWM_VERSION >= 2U) || defined (CY_DOXYGEN)
__STATIC_INLINE void Cy_TCPWM_Block_EnableCompare1Swap(TCPWM_Type *base, uint32_t cntNum,  BOOL8 enable);
...
__STATIC_INLINE void Cy_TCPWM_TriggerStart_Single(TCPWM_Type *base, uint32_t cntNum)
{
        ...
        TCPWM_CMD_START(base) = (1u << cntNum);
#else
...
__STATIC_INLINE void Cy_TCPWM_TriggerReloadOrIndex_Single(TCPWM_Type *base, uint32_t cntNum)
{
        ...
        TCPWM_CMD_RELOAD(base) = (1u << cntNum);
#else
        TCPWM_GRP_CNT_TR_CMD(base, TCPWM_GRP_CNT_GET_GRP(cntNum), cntNum) =
...
__STATIC_INLINE void Cy_TCPWM_TriggerCaptureOrSwap_Single(TCPWM_Type *base, uint32_t cntNum)
{
        ...
        TCPWM_CMD_CAPTURE(base) = (1u << cntNum);
#else
        TCPWM_GRP_CNT_TR_CMD(base, TCPWM_GRP_CNT_GET_GRP(cntNum), cntNum) =
...
__STATIC_INLINE cy_en_tcpwm_status_t Cy_TCPWM_SetDebugFreeze (TCPWM_Type *base, uint32 cntNum, BOOL8 enable)
{
    ...
    TCPWM_GRP_CNT_CTRL(base, TCPWM_GRP_CNT_GET_GRP(cntNum), cntNum) |= (enable ? TCPWM_GRP_CNT_V2_CTRL_DBG_FREEZE_EN_Msk : 0u);
