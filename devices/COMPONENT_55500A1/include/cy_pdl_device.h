...
#define adccomp_adr_base      0x8f3b0000
#define pdm2pcm_adr_base      0x8f3233c0
...
#ifdef PDM_PCM
#define CY_IP_PDM_PCM            1
#define CY_IP_PDM_PCM_VERSION    PDM_PCM_IP_VER
#endif

#ifdef ADCCOMP
#define CY_IP_ADCCOMP            1
#define CY_IP_ADCCOMP_VERSION    ADCCOMP_IP_VER
#endif
...
#define TCPWM_GRP_NR0_GRP_GRP_CNT_NR      TCPWM_IP_GRP0_CNT
...
/* Number of counters per TCPWM group (1..256) */
#define TCPWM_GRP_NR1_GRP_GRP_CNT_NR      TCPWM_IP_GRP1_CNT
...
#define TDM0_TDM_STRUCT1                        ((TDM_TDM_STRUCT_Type*) &TDM0->TDM_STRUCT[1])
#define TDM0_TDM_STRUCT1_TDM_TX_STRUCT          ((TDM_TDM_STRUCT_TDM_TX_STRUCT_Type*) &TDM1->TDM_STRUCT[1].TDM_TX_STRUCT)
#define TDM0_TDM_STRUCT1_TDM_RX_STRUCT          ((TDM_TDM_STRUCT_TDM_RX_STRUCT_Type*) &TDM1->TDM_STRUCT[1].TDM_RX_STRUCT)
...
#ifdef PDM_PCM
#include "cyip_pdm_pcm.h"

#define PDM_PCM_STRUCT_Type             CyPdmPcm_Type
#endif

#ifdef ADCCOMP
#include "cyip_adccomp.h"

#define ADCCOMP_STRUCT_Type                               CyADCCOMP_Type
#endif
