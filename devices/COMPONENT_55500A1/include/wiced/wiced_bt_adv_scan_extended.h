...
enum
{
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_CONNECTABLE_ADV = (1 << 0), /**< Connectable ADV */
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_SCANNABLE_ADV = (1 << 1),   /**< Scannable ADV */
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_DIRECTED_ADV = (1 << 2),    /**< Low duty cycle directed advertisement */
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_HIGH_DUTY_DIRECTED_CONNECTABLE_ADV = (1 << 3), /**< 3.75 ms Adv Interval,
                                                                                       only valid in legacy ADV */
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_LEGACY_ADV = (1 << 4),                         /**< Legacy Advertisement.
                                                                           Adv data cannot be more than 31 bytes.*/
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_ANONYMOUS_ADV = (1 << 5),    /**< Omits advertisers address from all PDUs */
    WICED_BLE_EXT_ADV_EVENT_PROPERTY_INCLUDE_TX_POWER = (1 << 6), /**< Include Tx power in ext ADV pdus */
 ...
 *
 * Extended Scan result callback (from calling #wiced_ble_ext_scan_start)
 *
...
enum wiced_ble_ext_initiator_filter_policy_e
{
...
/** Initiator filter policy used. (see #wiced_ble_ext_initiator_filter_policy_e) */
typedef uint8_t wiced_ble_ext_initiator_filter_policy_t;
...
/** Phy adv options to be set in #wiced_ble_ext_adv_set_parameters */
...
typedef struct
{
    ...
    wiced_ble_ext_initiator_filter_policy_t init_filter_policy;
...
typedef union
{
    ...
    wiced_ble_periodic_adv_sync_established_event_data_t sync_establish;
    /** Data for WICED_BLE_PERIODIC_ADV_REPORT_EVENT*/
    wiced_ble_periodic_adv_report_event_data_t periodic_adv_report;
    ...
    wiced_ble_periodic_adv_sync_transfer_event_data_t sync_transfer;
    ...
    wiced_ble_periodic_adv_subevent_data_req_event_data_t pawr_data_req;
    /** Data for WICED_BT_BLE_PAWR_RSP_REPORT_EVENT*/
    wiced_ble_periodic_adv_rsp_report_event_data_t pawr_rsp_report;
    /* @endcond */
...
typedef enum
{
     ...
     * \ref wiced_ble_periodic_adv_sync_established_event_data_t */
    WICED_BLE_PERIODIC_ADV_SYNC_ESTABLISHED_EVENT,
    /** Periodic adv report.  \ref wiced_ble_periodic_adv_report_event_data_t */
    WICED_BLE_PERIODIC_ADV_REPORT_EVENT,
    /** Periodic sync lost event.  \ref wiced_ble_periodic_adv_sync_handle_t */
    WICED_BLE_PERIODIC_ADV_SYNC_LOST_EVENT,
    /** Periodic Adv Sync Transfer Event.  \ref wiced_ble_periodic_adv_sync_transfer_event_data_t */
    WICED_BLE_PERIODIC_ADV_SYNC_TRANSFER_EVENT,

    /* @cond PAWR_API APIs for Periodic Advertising with Response*/
    /** PAWR event on advertiser to request for subevent data
     * \ref wiced_ble_periodic_adv_subevent_data_req_event_data_t */
    WICED_BT_BLE_PAWR_SUBEVENT_DATA_REQ_EVENT,
    /** PAWR event on advertiser to report the subevent response data
     * \ref wiced_ble_periodic_adv_rsp_report_event_data_t */
 ...
 */
    wiced_bt_dev_status_t wiced_ble_ext_adv_set_parameters(wiced_ble_ext_adv_handle_t adv_handle,
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_adv_set_data(wiced_ble_ext_adv_handle_t adv_handle,
                                                        uint16_t data_len,
                                                        uint8_t *p_data);
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_set_scan_rsp_data(wiced_ble_ext_adv_handle_t adv_handle,
                                                             uint16_t data_len,
                                                             uint8_t *p_data);
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_remove_adv_set(wiced_ble_ext_adv_handle_t adv_handle);
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_clear_adv_sets(void);
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_scan_config(wiced_ble_ext_scan_result_cback_t *p_ext_scan_cback,
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_scan_start(wiced_bool_t start,
 ...
 *
 */
    wiced_bt_dev_status_t wiced_ble_ext_create_conn(wiced_ble_ext_conn_cfg_t *p_ext_conn_cfg);

    /**
 * Callback wiced_bt_ble_adv_ext_event_cback_t
 *
 ...
 * @return void
 */
    typedef void (*wiced_bt_ble_adv_ext_event_cback_t)(wiced_ble_ext_adv_event_t event,
 ...
 *
 */
    void wiced_ble_ext_adv_register_cback(wiced_bt_ble_adv_ext_event_cback_t p_app_adv_ext_event_cb);
