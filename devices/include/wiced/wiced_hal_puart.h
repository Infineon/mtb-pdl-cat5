...
/// \param parity_t - PARITY_ODD for odd parity, PARITY_EVEN for even parity,
///                   PARITY_NONE for no parity.
/// \param stop_bit_t - STOP_BIT_1 for 1 stop bit, STOP_BIT_2 for 2 stop bits.
///
/// \return wiced_bool_t  - TRUE if the configuration was successfully set, FALSE
