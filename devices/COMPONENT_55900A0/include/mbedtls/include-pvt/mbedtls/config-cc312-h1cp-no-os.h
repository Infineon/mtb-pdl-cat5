...
// dummy macro to override <printf> & <fprintf>
#define DUMMY_MACRO_VARG(a, ...)
...
#define MBEDTLS_PLATFORM_FPRINTF_MACRO      DUMMY_MACRO_VARG /**< Default fprintf macro to use, can be undefined */
#define MBEDTLS_PLATFORM_PRINTF_MACRO        DUMMY_MACRO_VARG /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correclty zero-terminate the buffer! */
