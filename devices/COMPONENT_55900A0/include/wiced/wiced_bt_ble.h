...
*
* This API is called to encrypt advertising data
*
...
* @param[in] plaintext_len plaintext data len
*
...
*
* This API is called to decrypt advertising data
*
* @param[in] p_key        session key
* @param[in] p_iv         initialization vector
* @param[in] p_randomizer randomizer
...
/**
 * This API allows to set maximum transmission payload size to be used for LL DATA PDUs on a given connection
 *
