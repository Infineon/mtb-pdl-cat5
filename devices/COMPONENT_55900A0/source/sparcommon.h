...
/*  HFO Option Selection */
#define APP_CGS_HFO_OPTION_SEL_XTAL   0x1
#define APP_CGS_HFO_OPTION_SEL_TCXO   0x2

#if defined(APP_CFG_HFO_OPTION_SELECTION) && \
     ((APP_CFG_HFO_OPTION_SELECTION == APP_CGS_HFO_OPTION_SEL_XTAL) || \
	  (APP_CFG_HFO_OPTION_SELECTION == APP_CGS_HFO_OPTION_SEL_TCXO))
#define APP_CFG_HFO_OPTION_SEL                          APP_CFG_HFO_OPTION_SELECTION
#else
#define APP_CFG_HFO_OPTION_SEL                          APP_CGS_HFO_OPTION_SEL_XTAL
#endif

#define APP_CFG_CLOCK_CONFIG_MAX_FREQ_EN        ((APP_CFG_LPO_SRC_SEL << 4) |(APP_CFG_HFO_OPTION_SEL<<2) | APP_CFG_MAX_FREQ_EN)
