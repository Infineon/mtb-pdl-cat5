...
#endif // ifndef TX_MUTEX_ENABLE_PERFORMANCE_INFO
#define TX_MUTEX_INIT
#else // ifdef TX_INVOKE_INLINE_INITIALIZATION

/* No in-line initialization is supported, use standard function call.  */
VOID        _tx_mutex_initialize(VOID);
#endif // ifdef TX_INVOKE_INLINE_INITIALIZATION
...
/* Define default post mutex delete macro to whitespace, if it hasn't been defined previously
